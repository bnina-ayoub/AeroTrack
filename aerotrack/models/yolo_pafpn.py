...
class YOLOPAFPN(nn.Module):
    ...
    def __init__(
        ...
        super().__init__()
        self.backbone = CSPDarknet(depth, width, depthwise=depthwise, act=act, enable_eca=enable_eca)
